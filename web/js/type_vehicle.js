...
function dataTable() {
    table = $('#tableType').DataTable({
        ...
        ajax: {
            method: 'GET',
            url: 'http://localhost:8081/jerseyrent/webapi/TipoVehiculo',
            data: {},
...
function add(){
    ...
    $.ajax({
        url : 'http://localhost:8081/jerseyrent/webapi/TipoVehiculo/create',
        headers: { 
...
function update(){
    ...
    $.ajax({
        url : 'http://localhost:8081/jerseyrent/webapi/TipoVehiculo/update',
        headers: { 
...
function remove(){
    ...
    var nomb=$('#nameupd').val();
    $.ajax({
        url : 'http://localhost:8081/jerseyrent/webapi/TipoVehiculo/delete',
        headers: { 
