...
function dataTable() {
    table = $('#tableLicense').DataTable({
        ...
        ajax: {
            method: 'GET',
            url: 'http://ec2-18-216-104-139.us-east-2.compute.amazonaws.com:8080/JerseyHibernateRent/webapi/Licencia',
            data: {},
            dataSrc: 'licencia'
        },
        columns: [{
...
function add(){
    ...
    $.ajax({
        url : 'http://ec2-18-216-104-139.us-east-2.compute.amazonaws.com:8080/JerseyHibernateRent/webapi/Licencia/create',
        headers: { 
...
function update(){
    ...
    $.ajax({
        url : 'http://ec2-18-216-104-139.us-east-2.compute.amazonaws.com:8080/JerseyHibernateRent/webapi/Licencia/update',
        headers: { 
...
function remove(){
    ...
    var nomb=$('#nameupd').val();
    $.ajax({
        url : 'http://ec2-18-216-104-139.us-east-2.compute.amazonaws.com:8080/JerseyHibernateRent/webapi/Licencia/delete',
        headers: { 
