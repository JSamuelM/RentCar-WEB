...
function dataTable() {
    table = $('#tableDiscount').DataTable({
        ...
        ajax: {
            method: 'GET',
            url: 'http://localhost:8081/jerseyrent/webapi/DescuentoVehiculo',
            data: {},
...
function add(){
    ...
    var marc=$('#vehi').val();
    $.ajax({
        url : 'http://localhost:8081/jerseyrent/webapi/DescuentoVehiculo/create',
        headers: { 
...
function update(){
    ...
    $.ajax({
        url : 'http://localhost:8081/jerseyrent/webapi/DescuentoVehiculo/update',
        headers: { 
...
function remove(){
    ...
    $.ajax({
        url : 'http://localhost:8081/jerseyrent/webapi/DescuentoVehiculo/delete',
        headers: { 
