...
function dataTable() {
    table = $('#tableGas').DataTable({
        ...
        ajax: {
            method: 'GET',
            url: 'http://ec2-18-223-134-87.us-east-2.compute.amazonaws.com:8080/JerseyHibernateRent/webapi/Combustible',
            data: {},
            dataSrc: 'combustible'
        },
        columns: [{
...
function add(){
    ...
    $.ajax({
        url : 'http://ec2-18-223-134-87.us-east-2.compute.amazonaws.com:8080/JerseyHibernateRent/webapi/Combustible/create',
        headers: { 
...
function update(){
    ...
    $.ajax({
        url : 'http://ec2-18-223-134-87.us-east-2.compute.amazonaws.com:8080/JerseyHibernateRent/webapi/Combustible/update',
        headers: { 
...
function remove(){
    ...
    var nomb=$('#nameupd').val();
    $.ajax({
        url : 'http://ec2-18-223-134-87.us-east-2.compute.amazonaws.com:8080/JerseyHibernateRent/webapi/Combustible/delete',
        headers: { 
