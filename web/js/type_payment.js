...
function dataTable() {
    table = $('#tablePay').DataTable({
        ...
        ajax: {
            method: 'GET',
            url: 'http://localhost:8081/jerseyrent/webapi/TipoPago',
            data: {},
            dataSrc: 'tipoPago'
        },
        columns: [{
...
function add(){
    ...
    $.ajax({
        url : 'http://localhost:8081/jerseyrent/webapi/TipoPago/create',
        headers: { 
...
function update(){
    ...
    $.ajax({
        url : 'http://localhost:8081/jerseyrent/webapi/TipoPago/update',
        headers: { 
...
function remove(){
    ...
    var nomb=$('#nameupd').val();
    $.ajax({
        url : 'http://localhost:8081/jerseyrent/webapi/TipoPago/delete',
        headers: { 
