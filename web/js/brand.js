...
function update(){
    ...
    $.ajax({
        url : 'http://ec2-52-14-245-189.us-east-2.compute.amazonaws.com:8080/JerseyHibernateRent/webapi/update',
        headers: { 
...
function remove(){
    ...
    var nomb=$('#nameupd').val();
    $.ajax({
        url : 'http://ec2-52-14-245-189.us-east-2.compute.amazonaws.com:8080/JerseyHibernateRent/webapi/delete',
        headers: { 
